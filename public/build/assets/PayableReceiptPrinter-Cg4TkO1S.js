import{d as T}from"./dayjs.min-BnEQxWup.js";import"./id-Cl4jBuyU.js";import{Q as M}from"./qrcode.vue.esm-C2MJs9kw.js";import{Y as g,o as f,c,d as t,t as l,h as A,s as b,b as R,H as _}from"./main-BfRay8G6.js";import"./_commonjsHelpers-D6-XlEtG.js";const G={key:0,id:"print-payable-receipt-section"},J={key:0,class:"thermal-container"},F={class:"text-center"},W={class:"font-bold",style:{"font-size":"13px"}},q={style:{"font-size":"11px"}},Q={style:{"font-size":"9px"}},X={key:0,style:{"font-size":"9px"}},Z={class:"meta-table"},tt={key:0},et={class:"meta-table"},nt={class:"text-right"},at={class:"font-bold",style:{"font-size":"12px"}},it={class:"text-right"},ot={class:"text-right"},lt={class:"font-bold",style:{color:"#000"}},st={class:"text-right"},rt={style:{"font-size":"9px","font-style":"italic","margin-bottom":"6px"}},dt={style:{"text-align":"center",margin:"6px auto"}},mt={class:"text-center mt-2",style:{"font-size":"9px"}},ut={key:1,class:"kwitansi-frame"},pt={class:"header-table"},gt={style:{width:"58%","vertical-align":"top"}},ft={class:"store-name"},ct={class:"store-address"},bt={key:0,class:"store-address"},yt={style:{width:"42%","vertical-align":"top","text-align":"right"}},xt={class:"kwitansi-meta"},vt={class:"kwitansi-meta",style:{"font-size":"9.5px",color:"#333"}},ht={class:"form-table"},At={class:"form-fill-line"},wt={style:{"font-size":"12px","text-transform":"uppercase"}},kt={key:0,style:{"font-size":"10.5px",color:"#444","margin-left":"6px"}},Tt={class:"terbilang-box"},St={class:"form-fill-line"},Nt={class:"form-fill-line",style:{"font-size":"10.5px"}},zt={key:0},It={key:1},Dt={style:{"margin-left":"8px"}},Mt={class:"footer-table"},Rt={style:{width:"44%","vertical-align":"top"}},Et={class:"nominal-box"},Kt={class:"nominal-value"},Yt={style:{"margin-top":"6px",display:"flex","align-items":"center",gap:"6px",background:"#fafafa",border:"1px solid #ccc",padding:"4px 6px","border-radius":"3px","max-width":"240px"}},$t={style:{border:"1px solid #aaa",padding:"1px",background:"#fff",display:"inline-block"}},Ct={style:{width:"56%","vertical-align":"top"}},Pt={style:{"text-align":"right","font-size":"10px",color:"#333","margin-bottom":"4px"}},Bt={class:"ttd-table"},Ut={style:{width:"50%"}},Ht={class:"ttd-name"},Lt={style:{width:"50%"}},jt={style:{margin:"1px auto",display:"flex","flex-direction":"column","justify-content":"center","align-items":"center","min-height":"36px"}},Ot={style:{border:"1px solid #ccc",padding:"1px",background:"#fff",display:"inline-block"}},Vt={class:"ttd-name"},Qt={__name:"PayableReceiptPrinter",props:{statement:{type:Object,required:!1,default:null},payment:{type:Object,required:!1,default:null},branch:{type:Object,required:!1,default:null},setting:{type:Object,required:!1,default:null},printFormat:{type:String,default:"continuous_form"}},setup(s,{expose:P}){T.locale("id");const a=s,v=o=>new Intl.NumberFormat("id-ID").format(Math.round(o||0)),B=o=>o?T(o).format("DD-MM-YYYY"):"-",U=o=>o?T(o).format("DD-MM-YYYY HH:mm"):"-",E=o=>o?T(o).format("DD MMMM YYYY"):"-",H=o=>{const e=Math.floor(Math.abs(Number(o)||0));if(e===0)return"nol";const r=["","satu","dua","tiga","empat","lima","enam","tujuh","delapan","sembilan","sepuluh","sebelas"];function i(n){return n<12?r[n]:n<20?i(n-10)+" belas":n<100?i(Math.floor(n/10))+" puluh"+(n%10>0?" "+i(n%10):""):n<200?"seratus"+(n-100>0?" "+i(n-100):""):n<1e3?i(Math.floor(n/100))+" ratus"+(n%100>0?" "+i(n%100):""):n<2e3?"seribu"+(n-1e3>0?" "+i(n-1e3):""):n<1e6?i(Math.floor(n/1e3))+" ribu"+(n%1e3>0?" "+i(n%1e3):""):n<1e9?i(Math.floor(n/1e6))+" juta"+(n%1e6>0?" "+i(n%1e6):""):n<1e12?i(Math.floor(n/1e9))+" miliar"+(n%1e9>0?" "+i(n%1e9):""):n<1e15?i(Math.floor(n/1e12))+" triliun"+(n%1e12>0?" "+i(n%1e12):""):""}return i(e).replace(/\s+/g," ").trim()},K=g(()=>{var e;if(!((e=a.payment)!=null&&e.amount))return"";let o=H(a.payment.amount);return o.charAt(0).toUpperCase()+o.slice(1)+" rupiah"}),N=g(()=>{var o,e,r,i,n,p,m,u,y,w,k;if((e=(o=a.payment)==null?void 0:o.creator)!=null&&e.name)return a.payment.creator.name;if((i=(r=a.payment)==null?void 0:r.user)!=null&&i.name)return a.payment.user.name;if((m=(p=(n=a.payment)==null?void 0:n.creator)==null?void 0:p.employee)!=null&&m.name)return a.payment.creator.employee.name;if((y=(u=a.statement)==null?void 0:u.creator)!=null&&y.name)return a.statement.creator.name;try{const x=JSON.parse(localStorage.getItem("userData")||"{}");if(x!=null&&x.name)return x.name;const h=JSON.parse(localStorage.getItem("user")||"{}");if(h!=null&&h.name)return h.name}catch{}return((k=(w=a.branch)==null?void 0:w.owner)==null?void 0:k.name)||"Admin Toko"}),L=g(()=>{var o,e,r,i;return((e=(o=a.statement)==null?void 0:o.supplier)==null?void 0:e.contact_person)||((i=(r=a.statement)==null?void 0:r.supplier)==null?void 0:i.name)||"Pihak Supplier"}),d=g(()=>{var o;return a.branch||((o=a.statement)==null?void 0:o.branch)||{}}),Y=g(()=>{var r,i,n;if(a.printFormat==="thermal")return!0;const o=((i=(r=a.setting)==null?void 0:r.name)==null?void 0:i.toLowerCase())||"",e=((n=a.setting)==null?void 0:n.width)||"";return o.includes("thermal")||e.includes("58mm")||e.includes("80mm")}),j=g(()=>{var e,r;const o=((r=(e=a.setting)==null?void 0:e.name)==null?void 0:r.toLowerCase())||"";return o.includes("11 inch")||o.includes("11")}),O=g(()=>{var r,i,n;const o=((i=(r=a.setting)==null?void 0:r.name)==null?void 0:i.toLowerCase())||"",e=((n=a.setting)==null?void 0:n.width)||"";return o.includes("a5")||e.includes("210mm")}),V=g(()=>{var m,u,y;if(!a.payment)return"";const o=a.payment.payment_number||"KAS-KELUAR",e=((u=(m=a.statement)==null?void 0:m.supplier)==null?void 0:u.name)||"Supplier",r=d.value.name||"Cabang Utama",i=Number(a.payment.amount||0).toLocaleString("id-ID"),n=Number(((y=a.statement)==null?void 0:y.remaining_amount)||0).toLocaleString("id-ID"),p=B(a.payment.payment_date||a.payment.created_at);return`VERIFIKASI KEABSAHAN TRANSAKSI MS.POS
====================================
...
Status    : PENGELUARAN KAS SAH & TERCATAT RESMI`}),$=g(()=>{var r,i;const o=d.value.name||"Cabang Utama",e=T(((r=a.payment)==null?void 0:r.created_at)||new Date).format("DD/MM/YYYY HH:mm:ss");return`TANDA TANGAN DIGITAL RESMI (DIGITAL SIGNATURE)
===============================================
...
Status TTD    : TERTANDA DIGITAL SAH (VERIFIED)`});return P({print:()=>{var n,p,m,u,y,w,k,x,h;const o=document.getElementById("print-payable-receipt-section");if(!o){window.print();return}const e=document.createElement("iframe");e.style.position="fixed",e.style.right="0",e.style.bottom="0",e.style.width="0",e.style.height="0",e.style.border="0",document.body.appendChild(e);let r="";if(Y.value){const S=((n=a.setting)==null?void 0:n.width)||"80mm",z=((p=a.setting)==null?void 0:p.margin_top)??0,I=((m=a.setting)==null?void 0:m.margin_bottom)??0,D=((u=a.setting)==null?void 0:u.margin_left)??0,C=((y=a.setting)==null?void 0:y.margin_right)??0;r=`
      @page {
        size: ${S} auto;
    ...
    `}else{const S=((w=a.setting)==null?void 0:w.margin_top)??4,z=((k=a.setting)==null?void 0:k.margin_bottom)??4,I=((x=a.setting)==null?void 0:x.margin_left)??6,D=((h=a.setting)==null?void 0:h.margin_right)??6;r=`
      @page {
        size: ${j.value?"241mm 280mm":O.value?"210mm 148mm":"241mm 140mm"};
        margin: 0mm !important;
      }
      @media print {
        @page { margin: 0mm !important; }
