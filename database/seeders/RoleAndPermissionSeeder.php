...
class RoleAndPermissionSeeder extends Seeder
{
    public function run()
    {
        ...
        $adminCabangPerms = collect([
            ...
            'Kategori Barang Read', 'Data Supplier Read', 'Data Supplier Write', 'Data Supplier Create', 'Data Supplier Delete', 'Data Pelanggan Read', 'Data Pelanggan Write', 'Data Pelanggan Create', 'Data Pelanggan Delete',
            'Manajemen Karyawan Read', 'Manajemen Karyawan Write', 'Manajemen Karyawan Create', 'Manajemen Karyawan Delete',
            ...
            'Retur Barang Read', 'Retur Barang Create', 'Retur Barang Write',
            ...
            'Buku Piutang Pelanggan Read', 'Buku Piutang Pelanggan Write', 'Buku Piutang Pelanggan Create', 'Buku Piutang Pelanggan Delete',
            'Buku Hutang Supplier Read', 'Buku Hutang Supplier Write', 'Buku Hutang Supplier Create', 'Buku Hutang Supplier Delete',
            'Modal & ROI Cabang Read', 'Modal & ROI Cabang Create',
            ...
            'Pengaturan Read', 'Pengguna & PIN Kasir Read', 'Pengguna & PIN Kasir Write', 'Pengguna & PIN Kasir Create', 'Pengguna & PIN Kasir Delete',
        ...
        $kasirPerms = collect([
            ...
            'Data Produk & Barang Read', 'Kategori Barang Read',
            'Data Pelanggan Read', 'Data Pelanggan Create', 'Data Pelanggan Write',
