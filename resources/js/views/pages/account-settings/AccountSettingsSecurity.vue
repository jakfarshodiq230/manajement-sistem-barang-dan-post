...
<template>
  <VRow>
    ...
    <!-- SECTION: Create POS PIN -->
    <VCol cols="12">
      <VCard>
        <VCardItem class="pb-6">
          <VCardTitle>Pengaturan PIN Kasir (POS)</VCardTitle>
        </VCardItem>
        <VForm @submit.prevent="savePin">
          <VCardText class="pt-0">
            <p class="text-body-1 mb-6">
              PIN ini digunakan khusus bagi Kepala Cabang/Otorisator untuk menyetujui transaksi (Nego, Retur, dll) di mesin Kasir POS. 
              <br><strong>Harap rahasiakan PIN 6 digit ini.</strong>
            </p>
            <VRow>
              <VCol
                cols="12"
